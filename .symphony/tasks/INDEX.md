...
| 20260903-mirror-workspaces-group-natively-via-a-shadow-repository-oig1 | mirror workspaces group as children and show the native chip and worktree dropdown via a per-remote-repo shadow repository whose linked worktrees are the mirror cwds | open | herdr-mirror | - |
...
| 20260903-upstream-pr-of-the-four-mirror-landings-0ijo | one upstream PR to nikok6/herdr-mirror from the fork: the four mirror landings squashed into reviewable commits, README limitation line rewritten, linked issue explaining the token approach | cued | herdr-mirror | - |
