...
| 20260903-live-acceptance-mirror-worktrees-end-to-end-h6fp | live acceptance: mirror groups worktrees end to end on the running build — rebuild to d3fcbd4, group read-back, remote worktree create then remove, read-backs only | open | herdr-mirror | - |
