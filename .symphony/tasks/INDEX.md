...
| 20260903-shadow-repo-grouping-actually-engages-on-mirror-converge-fz6z | the shadow-repo grouping actually engages on mirror converge: mirror cwds become shadow worktrees, the shadow dir is populated, and rows group under one repo | open | herdr-mirror | - |
